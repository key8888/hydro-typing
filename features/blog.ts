...
//   Handler, ObjectId, OplogModel, PRIV, Types, UserModel,
// } from 'hydrooj';
...
export class BlogModel {
  ...
  static get(did: ObjectId): Promise<BlogDoc> {
    return DocumentModel.get('system', TYPE_BLOG, did);
  }
...
/** ルート登録＋i18n（Blog用） */
export function applyBlog(ctx: Context) {
